...
class MainPgaeWidget extends StatefulWidget {
  ...
  @override
  _MainPgaeWidgetState createState() => new _MainPgaeWidgetState (
    type,
    tabViews,
    indicatorColor,
    title,
...
class _MainPgaeWidgetState extends State<MainPgaeWidget>  with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    if (this._type == MainPgaeWidget.TOP_TAB) {
      ///顶部tab bar
      return new Scaffold(
